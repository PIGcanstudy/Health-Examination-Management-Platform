...
public class PageDTO<T> implements Serializable {
     ...
     * @return 返回分页数据对象
     */
    public static <T> com.zeroone.star.project.dto.PageDTO<T> create(Page<T> page) {
        com.zeroone.star.project.dto.PageDTO<T> pageResult = new com.zeroone.star.project.dto.PageDTO<>();
     ...
     * @return 返回分页数据对象
     */
    public static <T, D> com.zeroone.star.project.dto.PageDTO<T> create(Page<D> page, DataTransCallBack<T, D> callback) {
        //初始化分页信息
        com.zeroone.star.project.dto.PageDTO<T> pageResult = new com.zeroone.star.project.dto.PageDTO<>();
        pageResult.setTotal(page.getTotal());
        pageResult.setPageIndex(page.getCurrent());
     ...
     * @return 返回分页数据对象
     */
    public static <T, D> com.zeroone.star.project.dto.PageDTO<T> create(Page<D> page, Class<T> tClass) {
        //使用BeanUtil进行属性复制
