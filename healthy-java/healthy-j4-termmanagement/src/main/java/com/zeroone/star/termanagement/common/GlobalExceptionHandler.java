...
public class GlobalExceptionHandler {
     ...
     * @return 返回异常信息回显数据
     */
    @ExceptionHandler(value = OrgStructureException.class)
    public JsonVO<Void> orgStructureExceptionHandler(OrgStructureException e) {
        return JsonVO.create(null, OrgStructureException.CODE, e.getMessage());
    }
