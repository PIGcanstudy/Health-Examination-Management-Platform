              ...
              <el-col :span="20">
                <el-form :model="basicForm" inline>
                  <el-form-item label="名称" :label-width="labelWidth">
                    <el-input v-model="basicForm.SampleName" placeholder="请输入名称" style="width: 232px"></el-input>
                  </el-form-item>
                  <el-form-item label="体检类型" :label-width="labelWidth">
                    <el-select v-model="basicForm.examinationType" style="width: 232px"></el-select>
                  </el-form-item>
                  <el-form-item label="统一社会标本代码" :label-width="labelWidth">
                    <el-input v-model="basicForm.SampleCode" placeholder="请输入统一社会标本代码" style="width: 232px"></el-input>
                  </el-form-item>
...
const tableColumnAttribute = ref([
  { prop: 'name', label: '名称', width: '240', align: 'center' },
  { prop: 'credit', label: '标本代码', width: '120', align: 'center' },
