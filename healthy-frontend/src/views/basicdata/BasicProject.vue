      ...
      >
        ...
        <template #form>
          ...
          <el-form-item label="项目代码">
            <el-input v-model="searchForm.projectCode" placeholder="请输入项目代码"></el-input>
          </el-form-item>
          <el-form-item>
...
const tableColumnAttribute = ref([
  { prop: 'projectCode', label: '项目代码', width: '120', align: 'center' },
  { prop: 'projectName', label: '项目名称', width: '120', align: 'center' },
  { prop: 'projectAbb', label: '简称', width: '120', align: 'center' },
  { prop: 'projectUnit', label: '项目单位', width: '120', align: 'center' },
  { prop: 'defaultValue', label: '默认值', width: '120', align: 'center' },
  { prop: 'resultType', label: '结果类型', width: '120', align: 'center' },
  { prop: 'summary', label: '是否进入小结', width: '120', align: 'center' },
  { prop: 'report', label: '是否进入报告', width: '120', align: 'center' },
  { prop: 'lis', label: 'LIS关联码', width: '120', align: 'center' }
])
// 表格数据
const tableData = ref([
  {
    projectCode: '乐山市峨边盛和矿业',
    projectName: '--',
    projectAbb: '健康体检',
    projectUnit: '--',
    defaultValue: '铁矿采选*',
