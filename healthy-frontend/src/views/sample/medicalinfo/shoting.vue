<template>
  <el-dialog v-model="show" title="人脸采集" class="photograph" :close-on-click-modal="false">
    ...
    <span class="dialog-footer">
      ...
      <el-button type="success" @click="confirmSubmit">确认</el-button>
    </span>
  </el-dialog>
</template>
