...
<template>
  <div class="container">
    <div class="pic">
      <div class="pic-box" >
        <i class="ivu-icon ivu-icon-ios-add" style="font-size: 24px; color: rgb(41, 136, 243); "></i>
        <span style="height: auto; line-height: 0; margin-top: 30px; color: rgb(41, 136, 243)">人脸采集</span>
      </div>
    </div>
    <!-- 按钮用于触发人脸采集 -->
    <el-button type="primary" @click="showPhotograph = true" style="margin-right: 20px">开始人脸采集</el-button>
    <!-- 人脸采集 -->
    <div class="shoting" v-if="showPhotograph">
      <shoting v-model="showPhotograph" v-on:handleSearch="handleSetImg" />
    </div>
    <!-- 右侧卡片 -->
      ...
      <div class="step">
        <ul>
          <li v-for="(item, index) in data" :key="index">
            <div v-if="index == 0">
              <img src="../../../assets/step/start_check.png" v-if="type > 0" />
              <img src="../../../assets/step/start_nomal.png" v-else />
            </div>
            <div v-if="index > 0 && index < data.length - 1">
              <img src="../../../assets/step/mid_check.png" v-if="type > 1 && index < type" />
              <img src="../../../assets/step/mid_nomal.png" v-else />
            </div>
            <div v-if="index == data.length - 1">
              <img src="../../../assets/step/end_check.png" v-if="type == data.length" />
              <img src="../../../assets/step/end_nomal.png" v-else />
            </div>
            <span>{{ item }}</span>
          </li>
        </ul>
...
<!-- eslint-disable prettier/prettier -->
<script>
import shoting from './shoting.vue'
export default {
  name: 'MedicalInfo',
  components: {
    shoting
