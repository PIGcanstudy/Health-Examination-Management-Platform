...
*/
#ifndef _ADDPEOPLE_MAPPER_
#define _ADDPEOPLE_MAPPER_
 ...
 * Ê¾Àý±í×Ö¶ÎÆ¥ÅäÓ³Éä
 */
class AddPeopleMapper : public Mapper<AddDO>
{
public:
	AddDO mapper(ResultSet* resultSet) const override
	{
		AddDO data;
