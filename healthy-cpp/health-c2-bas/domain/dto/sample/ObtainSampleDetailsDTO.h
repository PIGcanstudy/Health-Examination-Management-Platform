 ...
 * 示例传输对象
 */
class ObtainSampleDetailsDTO : public oatpp::DTO
{
	DTO_INIT(ObtainSampleDetailsDTO, DTO);
	//名称
 ...
 * 示例分页传输对象
 */
class ObtainSampleDetailsPageDTO : public PageDTO<ObtainSampleDetailsDTO::Wrapper>
{
	DTO_INIT(ObtainSampleDetailsPageDTO, PageDTO<ObtainSampleDetailsDTO::Wrapper>);
};
