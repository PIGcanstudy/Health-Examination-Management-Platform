...
bool getStartArg(int argc, char* argv[]) {
	...
	std::string dbHost = "192.168.136.131";
	int dbPort = 3306;
	int dbMax = 5;
#ifdef LINUX
	// Nacos配置参数
...
int main(int argc, char* argv[]) {
	...
	//ReviewFastDfs("D:\\zero-one-star\\zero-one-healthy-check\\healthy-cpp\\out\\build\\x64-Debug\\healthy-c7-common\\test-text.pdf");
	//ReviewPdf::testText();
	//ReviewPdf::ReviewTpl(Do);
#ifdef LINUX
	// 创建Nacos客户端对象
