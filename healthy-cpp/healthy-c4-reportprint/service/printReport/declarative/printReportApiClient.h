 ...
 */
class printReportApiClient : public oatpp::web::client::ApiClient // 2 继承这个类
{
...
#include OATPP_CODEGEN_BEGIN(ApiClient)
	...
	// 通过ID查询
	// API_CALL(API_M_GET, "/query-one", queryById, API_HANDLER_AUTN_HEADER, QUERY(UInt64, id));
	// 多条件查询
	// API_CALL(API_M_GET, "/query-all", queryAll, API_HANDLER_AUTN_HEADER, API_HANDLER_PAGE_PARAME, QUERY(String, name));
